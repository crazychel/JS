let startBtn = document.getElementById('start'),
    ...
    dayBadgetValue = document.getElementsByClassName('daybudget-value')[0],
    ...
    expensesBtn = confirm[0],
    optionalExpensesBtn = confirm[1],
    countBtn = confirm[2],
...
startBtn.addEventListener('click', function () {
    ...
    confirm[1].style.display = 'block';
    confirm[2].style.display = 'block';
...
countBtn.addEventListener('click', function () {
    ...
    if (appData.budget != undefined) {
        ...
        dayBadgetValue.textContent = appData.moneyPerDay;
        ...
        dayBadgetValue.textContent = 'Введите доход пожалуйста (кнопка: начать расчет)';
    }
});
